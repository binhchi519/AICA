...
namespace StockManagementSystem.DTO
{
    public class CompareERP
    {
        ...
        public CompareERP(DateTime stockInDate, string itemCode, string itemCodeERP, int stockQuantity, int eRPData, int differrence)
        {
